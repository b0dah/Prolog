...
% ========= MARK: solution ===============================================================
solve(F,S, StringRes) :- split_string(F, ' ', '', FL), split_string(S, ' ', '', SL), workWithLists(FL, SL, FRes), workWithLists(SL, FL, SRes), append(FRes, SRes, Res),  atomics_to_string(Res, " ", StringRes).
